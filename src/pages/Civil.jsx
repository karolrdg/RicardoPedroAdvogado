...
export default function Civil() {
    ...
    const demandas = [
        {
            titulo: "Inventários",
            destaque: "Seu inventário em até 40 dias", // Novo campo de destaque
            ...
            <section className="py-24 px-6 max-w-6xl mx-auto">
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    {demandas.map((item, idx) => (
                        <div key={idx} className={`group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border-l-4 flex gap-6 items-start relative ${item.destaque ? 'border-secondary ring-2 ring-secondary/10' : 'border-secondary/20 hover:border-secondary'}`}>
